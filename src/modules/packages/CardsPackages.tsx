    ...
    <SectionCardsCss>
      ...
      >
        <CardPackageCss>
          ...
          <ButtonPrimary bgcolor="black" color="white" padding="20px 8em" hoverbgcolor="var(--theme)">Elegir Paquete</ButtonPrimary>
          <PriceItemsCss>
            <PriceTitleCss>
      ...
      >
        <CardPackageCss backgroundcolor="var(--theme)">
          ...
          <ButtonPrimary bgcolor="var(--theme)" color="white" hovercolor="black" hoverborder="var(--white) solid 2px" border="var(--white) solid 2px" padding="20px 8em" hoverbgcolor="var(--white)">Elegir Paquete</ButtonPrimary>
          <PriceItemsCss>
