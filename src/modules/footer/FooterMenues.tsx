    ...
    return (
        <SectionMenuesCss>
            <ContentMenuCss>
                ...
                <ContentSocialIconsCss>
                    <LinkMenuCss href="https://www.facebook.com/Tcompra/"><IconContentSocialCss><ImgIcon src={facebookIcon} alt="icon" /></IconContentSocialCss></LinkMenuCss>
                    <LinkMenuCss href="https://www.instagram.com/tcompralatam/"><IconContentSocialCss><ImgIcon src={instagramIcon} alt="icon" /></IconContentSocialCss></LinkMenuCss>
                    <LinkMenuCss href="https://www.youtube.com/channel/UCMllmt4Yz6googZOS9qPlLA"><IconContentSocialCss><ImgIcon src={youtubeIcon} alt="icon" /></IconContentSocialCss></LinkMenuCss>
                    <LinkMenuCss href="https://www.linkedin.com/company/tcompra"><IconContentSocialCss><ImgIcon src={linkedinIcon} alt="icon" /></IconContentSocialCss></LinkMenuCss>
                </ContentSocialIconsCss>
            </ContentMenuCss>
            ...
            <SectionEnd>
                ...
                <WidgetEnd><LinkMenuCss href="#Homes"><ItemUpCss><ImgUpCss src={ImgUp} alt="img" /></ItemUpCss></LinkMenuCss></WidgetEnd>
