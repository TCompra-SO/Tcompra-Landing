  ...
  return (
    <Header>
      ...
      <MenuSlideout $isopen={menuOpen}>
        ...
        <ContentSocialIconsCss>
          <LinkMenuCss href=""><IconContentSocialCss bgcolor='#1d1d1d'><ImgIcon src={facebookIcon} /></IconContentSocialCss></LinkMenuCss>
          <LinkMenuCss href=""><IconContentSocialCss bgcolor='#1d1d1d'><ImgIcon src={instagramIcon} /></IconContentSocialCss></LinkMenuCss>
          <LinkMenuCss href=""><IconContentSocialCss bgcolor='#1d1d1d'><ImgIcon src={youtubeIcon} /></IconContentSocialCss></LinkMenuCss>
          <LinkMenuCss href=""><IconContentSocialCss bgcolor='#1d1d1d'><ImgIcon src={linkedinIcon} /></IconContentSocialCss></LinkMenuCss>
        </ContentSocialIconsCss>
      </MenuSlideout>
